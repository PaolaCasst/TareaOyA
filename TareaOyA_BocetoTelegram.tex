...
\begin{enumerate}[label=(\arabic{section}.\arabic{subsection}.\arabic{enumi})]
    ...
    El tiempo de ejecucion de la computadora 4 es 4 veces que la computadora 1
    ...
    El rendimiento de la computadora 2 es 3 veces que la computadora 1
    ...
    La computadora 2 tiene mejor desempeño y la computadora 1 tiene el pero desempeño.
    ...
    La computadora 4 tiene mejor GPU, mientras que la computadora 2 tiene mejor RAM. Siendo la RAM la mas determinante para la mayoria de pruebas
\end{enumerate}
